...
export const infoArrayAdministracion = [
  {
    id: 1,
    nombre: "Aurora",
    cargo: "Secretaria",
    photo: "../../public/aurora.jfif",
    descripcion:
      "Aurora supervisa todos los documentos que se realizan en la oficina. Puede pasar como ayudante del director. Es responsable del buen funcionamiento de la oficina. Elabora cartas, memorándums y certificaciones. ",
  },
  {
    id: 2,
    nombre: "Mirian",
    cargo: "Secretaria",
    photo: "../../public/nulfa.jfif",
    descripcion:
      "Mirian se encarga de entregar los registros a los maestros. Hacer las estadísticas de inicio con el fin de servirle a personas que van en buscar la informacion al centro. Maneja la caja y trabaja la inscripción de los estudiantes. ",
  },
  {
    id: 3,
    nombre: "Nulfa",
    cargo: "Secretaria",
    photo: "../../public/mirian.jfif",
    descripcion:
      "Nulfa trabaja el proceso de inscripcion. Realiza los records de notas. Atiende las llamadas telefónicas. Formaliza los listados de los estudiantes cuando hay inscripciones. ",
  },
  {
    id: 4,
    nombre: "Melania",
    cargo: "Secretaria",
    photo: "../../public/melania.jfif",
    descripcion:
      "Melania realiza records de notas. Se encarga de cobrar la cuota a los estudiantes y llamar a las familias cuando los expedientes llegan firmados del distrito. ",
  },
];
